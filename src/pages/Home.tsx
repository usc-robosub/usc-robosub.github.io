...
function Home() {
    ...
    const events = [
        {
            name: "Build Hours",
            date: "January 22, 2025 | HNB Basement | 7-9 PM",
            icon: Calendar
        },
        {
            name: "Build Hours",
            date: "January 27, 2025 | HNB Basement | 7-9 PM",
            icon: Calendar
        },
        {
            name: "General Meeting",
            date: "February 5, 2025 | TBD | 7-9 PM",
            icon: Calendar
        }
    ];
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="max-w-3xl mx-auto space-y-6">
                        {events.map((event) => {
                            ...
                            return (
                                <div key={event.name} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow flex items-center gap-6">
                                    <IconComponent className="w-12 h-12 text-blue-600 flex-shrink-0" />
                                    <div>
